...
When referring to our IoT testbed, we refer to the IoT devices, any connected hardware to log the power data, and the database where all the data is stored.
